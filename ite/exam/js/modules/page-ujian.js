        ...
        currentSoal.assets.forEach(asset => {
            ...
            if (asset.asset_type === 'local_image' || asset.asset_type === 'external_image') {
                ...
                if (asset.asset_type === 'local_image') {
                    src = src.startsWith('exam_assets/') ? '/storage/' + src : '/storage/exam_assets/' + src;
                }
                ...
                assetWrapper.classList.add('embed-asset');
                let src = asset.asset_source.startsWith('exam_assets/') ? '/storage/' + asset.asset_source : '/storage/exam_assets/' + asset.asset_source;
