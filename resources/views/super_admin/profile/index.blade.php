...
@section('title', 'Tentang Saya | GARA Super Admin')
@push('styles')
<style>
...
@section('content')
    <div class="profile-hero text-white text-center">
        <form id="formFoto" action="{{ route('superadmin.profile.photo') }}" method="POST" enctype="multipart/form-data">
            @csrf
    ...
    <div class="container float-card px-3 pb-5" style="max-width:660px;">
        ...
        <div class="card profile-card">
            ...
            <div class="card-body px-4">
                ...
                <div class="info-row"><span class="info-label">Role</span><span class="info-val"><span class="badge badge-danger" style="border-radius:20px;">Super Admin</span></span></div>
...
<script>
    ...
    function uploadPhoto(file) {
        ...
        fetch('{{ route('superadmin.profile.photo') }}', {
            method: 'POST',
            body: formData,
