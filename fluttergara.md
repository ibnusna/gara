...
* **Path Berkas:** [main.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/main.dart)
...
// ==========================================================================
// FILE: lib/main.dart
// DESKRIPSI: Entry point utama aplikasi GARA Mobile.
// ==========================================================================
...
void main() async {
  ...
  // Mengunci orientasi layar ke portrait vertikal demi estetika UI/UX
  await SystemChrome.setPreferredOrientations([
    DeviceOrientation.portraitUp,
  ]);
  
  // Melakukan pengecekan token sesi dari local storage secara asinkron
...
* **Path Berkas:** [app_constants.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/utils/app_constants.dart)
...
// DESKRIPSI: Penyimpanan global constants & key-value local storage.
// ==========================================================================
...
class GaraColors {
  ...
  // Skema warna global dasbor web manajemen
  ...
  // Skema warna siswa (Student Native UI)
...
* **Path Berkas:** [app_config.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/utils/app_config.dart)
...
// DESKRIPSI: Konfigurasi target domain, base URL, dan pendeteksi environment.
// ==========================================================================
...
class AppConfig {
  ...
  // Environment rilis produksi diarahkan langsung ke domain GARA resmi
...
* **Path Berkas:** [note_model.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/models/note_model.dart)
...
// DESKRIPSI: Model data catatan pelajaran dengan dukungan multi-block content.
// ==========================================================================
...
* **Path Berkas:** [focus_model.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/models/focus_model.dart)
* **Tujuan:** Penampung data parameter timer Pomodoro, total durasi fokus, streak belajar harian, dan variabel tanaman gamifikasi.

```dart
// ==========================================================================
// FILE: lib/models/focus_model.dart
// DESKRIPSI: Model parameter setelan durasi, log statistik, streak fokus.
// ==========================================================================
...
class FocusData {
  ...
  int plantLevel;
  Map<String, int> history; // 'YYYY-MM-DD' -> sessions count
...
* **Path Berkas:** [mapel_model.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/models/mapel_model.dart)
* **Tujuan:** Menentukan kelas pembungkus metadata mata pelajaran yang ditarik dari API REST backend.

```dart
// ==========================================================================
// FILE: lib/models/mapel_model.dart
// DESKRIPSI: Model representasi data mata pelajaran yang diikuti siswa.
// ==========================================================================
...
* **Path Berkas:** [trivia_model.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/models/trivia_model.dart)
* **Tujuan:** Model untuk satu soal trivia Brain Warmup.

```dart
// ==========================================================================
// FILE: lib/models/trivia_model.dart
// DESKRIPSI: Model dan database internal lokal soal trivia.
// ==========================================================================
...
* **Path Berkas:** [auth_service.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/services/auth_service.dart)
...
// DESKRIPSI: Manajemen session otentikasi, login REST API, profil, & status ujian.
// ==========================================================================
...
* **Path Berkas:** [notes_service.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/services/notes_service.dart)
* **Tujuan:** Modul CRUD catatan siswa offline-first menggunakan SharedPreferences.

```dart
// ==========================================================================
// FILE: lib/services/notes_service.dart
// DESKRIPSI: Penyimpanan local offline CRUD notes siswa.
// ==========================================================================
...
* **Path Berkas:** [focus_service.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/services/focus_service.dart)
...
// DESKRIPSI: Penyimpanan riwayat durasi timer fokus & gamifikasi tanaman.
// ==========================================================================
...
* **Path Berkas:** [connectivity_service.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/services/connectivity_service.dart)
...
// DESKRIPSI: Pemantauan internet adaptor & HTTP ping server.
// ==========================================================================
...
* **Path Berkas:** [notification_service.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/services/notification_service.dart)
* **Tujuan:** Layanan sinkronisasi API notifikasi Laravel Sanctum.

```dart
// ==========================================================================
// FILE: lib/services/notification_service.dart
// DESKRIPSI: Service penarikan data notifikasi dari database web Laravel.
// ==========================================================================
...
* **Path Berkas:** [login_page.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/screens/login_page.dart)
...
// DESKRIPSI: Layar login interaktif siswa dengan otentikasi Sanctum & Handoff.
// ==========================================================================
...
* **Path Berkas:** [pilih_mapel_page.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/screens/pilih_mapel_page.dart)
* **Tujuan:** Grid mata pelajaran dengan indikator deteksi status ujian sekolah yang terintegrasi secara dinamis.

```dart
// ==========================================================================
// FILE: lib/screens/pilih_mapel_page.dart
// DESKRIPSI: Penampil daftar mata pelajaran & tombol masuk ujian aktif.
// ==========================================================================
...
* **Path Berkas:** [dashboard_page.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/screens/dashboard_page.dart)
...
// DESKRIPSI: Dasbor utama siswa, polling notifikasi background, & deep-linking.
// ==========================================================================
...
* **Path Berkas:** [ruang_fokus_page.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/screens/ruang_fokus_page.dart)
* **Tujuan:** Modul pengatur timer Pomodoro luring (offline) dengan konsep gamifikasi menyiram tanaman virtual.

```dart
// ==========================================================================
// FILE: lib/screens/ruang_fokus_page.dart
// DESKRIPSI: Timer Pomodoro belajar native luring dengan gamifikasi tanaman.
// ==========================================================================
...
* **Path Berkas:** [ruang_catatan_page.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/screens/ruang_catatan_page.dart)
...
```dart
// ==========================================================================
// FILE: lib/screens/ruang_catatan_page.dart
// DESKRIPSI: Manajemen folder kategori, indeks visual, pencarian catatan siswa.
// ==========================================================================
...
* **Path Berkas:** [note_editor_page.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/screens/note_editor_page.dart)
...
```dart
// ==========================================================================
// FILE: lib/screens/note_editor_page.dart
// DESKRIPSI: Rich text block editor untuk mencatat ringkasan pelajaran siswa.
// ==========================================================================
...
* **Path Berkas:** [hybrid_wrapper.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/widgets/hybrid_wrapper.dart)
...
```dart
// ==========================================================================
// FILE: lib/widgets/hybrid_wrapper.dart
// DESKRIPSI: Pembungkus InAppWebView berkeamanan tinggi dengan integrasi native.
// ==========================================================================
...
* **Path Berkas:** [hero_card.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/widgets/dashboard/hero_card.dart)
* **Tujuan:** Widget Hero Card di atas dasbor siswa.

```dart
// ==========================================================================
// FILE: lib/widgets/dashboard/hero_card.dart
// DESKRIPSI: Gradient banner dasbor siswa dengan statistik poin & ganti mapel.
// ==========================================================================
...
* **Path Berkas:** [main_menu_grid.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/widgets/dashboard/main_menu_grid.dart)
* **Tujuan:** Grid menu 6 ruang (Belajar, Tugas, Kompetensi, Fokus, Diskusi, Catatan) pada dasbor siswa.

```dart
// ==========================================================================
// FILE: lib/widgets/dashboard/main_menu_grid.dart
// DESKRIPSI: Grid menu 6 ruang dengan adaptabilitas offline dan handoff web.
// ==========================================================================
...
* **Path Berkas:** [sholat_widget.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/widgets/dashboard/sholat_widget.dart)
* **Tujuan:** Widget jadwal sholat real-time asinkron menggunakan Aladhan API dengan fallback cache SharedPreferences.

```dart
// ==========================================================================
// FILE: lib/widgets/dashboard/sholat_widget.dart
// DESKRIPSI: Jadwal Sholat Widget — Real-time dari Aladhan API dengan offline cache.
// ==========================================================================
...
* **Path Berkas:** [trivia_widget.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/widgets/dashboard/trivia_widget.dart)
* **Tujuan:** Widget interaktif Brain Warmup Trivia dengan feedback instan dan pergantian soal asinkron otomatis.

```dart
// ==========================================================================
// FILE: lib/widgets/dashboard/trivia_widget.dart
// DESKRIPSI: Widget quiz interaktif Brain Warmup penambah wawasan siswa.
// ==========================================================================
...
* **Path Berkas:** [jelajah_ilmu_grid.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/widgets/dashboard/jelajah_ilmu_grid.dart)
* **Tujuan:** Grid shortcut jelajah link web interaktif luar LMS.

```dart
// ==========================================================================
// FILE: lib/widgets/dashboard/jelajah_ilmu_grid.dart
// DESKRIPSI: Grid menu eksternal untuk mengakses ensiklopedia / perpus online.
// ==========================================================================
...
* **Path Berkas:** [home_tab.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/screens/tabs/home_tab.dart)
* **Tujuan:** Tab konten beranda dashboard dengan dynamic exam active banner.

```dart
// ==========================================================================
// FILE: lib/screens/tabs/home_tab.dart
// DESKRIPSI: Modul tab halaman utama dashboard dengan polling pintu ujian aktif.
// ==========================================================================
...
* **Path Berkas:** [akun_tab.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/screens/tabs/akun_tab.dart)
* **Tujuan:** Tab profil pengguna dengan panel pengelolaan sesi belajar luring (offline) dan logout.

```dart
// ==========================================================================
// FILE: lib/screens/tabs/akun_tab.dart
// DESKRIPSI: Tab Akun Saya untuk menampilkan profil siswa & trigger logout.
// ==========================================================================
...
* **Path Berkas:** [notifikasi_tab.dart](file:///var/www/html/eduap_broken/hosting/gara_flutter/lib/screens/tabs/notifikasi_tab.dart)
* **Tujuan:** Tab khusus notifikasi belajar siswa yang menampilkan list push alerts dari admin, guru, dan pengumuman kelas.

```dart
// ==========================================================================
// FILE: lib/screens/tabs/notifikasi_tab.dart
// DESKRIPSI: Tab Penampil Notifikasi Siswa dengan Refreshed indicator.
// ==========================================================================
...
* **Path Berkas:** [MainActivity.kt](file:///var/www/html/eduap_broken/hosting/gara_flutter/android/app/src/main/kotlin/com/example/gara_flutter/MainActivity.kt)
...
```kotlin
// ==========================================================================
// FILE: android/app/src/main/kotlin/com/example/gara_flutter/MainActivity.kt
// DESKRIPSI: Integrasi native Android Platform Channel untuk keamanan ujian.
// ==========================================================================
...
* **Path Berkas:** [pubspec.yaml](file:///var/www/html/eduap_broken/hosting/gara_flutter/pubspec.yaml)
